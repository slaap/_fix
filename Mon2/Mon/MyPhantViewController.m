...
@interface MyPhantViewController ()
...
@implementation MyPhantViewController
...
- (void)viewDidLoad
{
    ...
    UITabBarItem *item = [self.myNavBar.items objectAtIndex:selectedTab];
    [self.myNavBar setSelectedItem:item];
}
